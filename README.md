...
> **Note:** The installer performs registry edits, file linking, and configuration to ensure seamless local execution. If you wish to download it via GitHub, please place it in the C drive as C:\RedMoon3944 and run the Registry-Edit file with administrator privileges. A direct download link can be found here: https://drive.google.com/uc?export=download&id=1qzdRTBU0fm4YHivsRS_5e-XzG7T4ffG3
